...
fama_french_3F_portfolio <- function(port, from_date, to_date){
...
fama_french_3F <- function(ticker, from_date, to_date){
...
fama_french_5F <- function(ticker, from_date, to_date){
